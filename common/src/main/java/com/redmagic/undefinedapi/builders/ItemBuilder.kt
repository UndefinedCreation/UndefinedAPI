...
class ItemBuilder(private var itemStack: ItemStack) {
     ...
     */
    fun setName(name: String): com.redmagic.undefinedapi.builders.ItemBuilder {
        this.name = name
        return this
    }
     ...
     * @param flag
     */
    fun addFlags(flag: ItemFlag): com.redmagic.undefinedapi.builders.ItemBuilder {
        flags.add(flag)
        return this
    }
     ...
     */
    fun addEnchant(enchantment: Enchantment, level: Int): com.redmagic.undefinedapi.builders.ItemBuilder {
     ...
     */
    fun setEnchants(enchantment: HashMap<Enchantment, Int>): com.redmagic.undefinedapi.builders.ItemBuilder {
     ...
     * @return the ItemBuilder instance
     */
    fun setUnbreakable(boolean: Boolean): com.redmagic.undefinedapi.builders.ItemBuilder {
        unbreakable = boolean
        return this
    }
     ...
     */
    fun setSkullOwner(uuid: UUID): com.redmagic.undefinedapi.builders.ItemBuilder {
     ...
     * @return The ItemBuilder instance.
     */
    fun setLore(lore: MutableList<String>): com.redmagic.undefinedapi.builders.ItemBuilder {
        this.lore = lore
        return this
    }

    fun addLine(line: String): com.redmagic.undefinedapi.builders.ItemBuilder {
        this.lore.add(line)
        return this
    }
     ...
     */
    fun setAmount(amount: Int): com.redmagic.undefinedapi.builders.ItemBuilder {
        this.amount = amount
        return this
    }
     ...
     */
    fun setCustomModelData(customModelData: Int): com.redmagic.undefinedapi.builders.ItemBuilder {
     ...
     * @return The ItemBuilder instance.
     */
    fun setLocalizedName(name: String): com.redmagic.undefinedapi.builders.ItemBuilder {
