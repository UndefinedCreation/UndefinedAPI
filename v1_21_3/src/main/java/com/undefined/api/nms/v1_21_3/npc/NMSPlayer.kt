...
import com.undefined.api.nms.v1_21_3.entity.NMSLivingEntity
import com.undefined.api.nms.v1_21_3.extensions.getConnection
...
class NMSPlayer: NMSPlayer, NMSLivingEntity {
    ...
    override fun sendBasePackets(player: Player) {
        ...
        val serverEntity = ServerEntity(craftWorld.handle,
        ...
        val addEntityPacket = ClientboundAddEntityPacket(serverPlayer, serverEntity)
