...
import com.redmagic.undefinedapi.NMSManager1_20_6
 ...
 */
class PacketListenerManager1_20_6 {
    ...
    fun handleNPCInterat(msg: ServerboundInteractPacket){
        ...
        NMSManager1_20_6.npcInteraction.entries.forEach {
