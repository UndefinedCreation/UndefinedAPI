...
fun ServerCommonPacketListenerImpl.getConnection(): Connection {
    val field = ServerCommonPacketListenerImpl::class.java.getDeclaredField(com.undefined.api.nms.v1_20_6.SpigotNMSMappings.ServerCommonPacketListenerImplConnection)
