...
fun Display.getScaleAccessor(): EntityDataAccessor<Vector3f> {
    ...
    val f = Display::class.java.getDeclaredField(com.undefined.api.nms.v1_20_6.SpigotNMSMappings.DisplayScale)
...
fun Display.getTranslationAccessor(): EntityDataAccessor<Vector3f> {
    val f = Display::class.java.getDeclaredField(com.undefined.api.nms.v1_20_6.SpigotNMSMappings.DisplayTransfrom)
    f.isAccessible = true
    return f.get(this) as EntityDataAccessor<Vector3f>
}

fun Display.getLeftRotation(): EntityDataAccessor<Quaternionf> {
    val f = Display::class.java.getDeclaredField(com.undefined.api.nms.v1_20_6.SpigotNMSMappings.DisplayLeftRot)
    f.isAccessible = true
    return f.get(this) as EntityDataAccessor<Quaternionf>
}

fun Display.getRightRotation(): EntityDataAccessor<Quaternionf> {
    val f = Display::class.java.getDeclaredField(com.undefined.api.nms.v1_20_6.SpigotNMSMappings.DisplayRightRot)
    f.isAccessible = true
    return f.get(this) as EntityDataAccessor<Quaternionf>
}
