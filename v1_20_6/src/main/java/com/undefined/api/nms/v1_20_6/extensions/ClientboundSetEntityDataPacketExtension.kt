 ...
 */
fun ClientboundSetEntityDataPacket.getEntityID() = getPrivateField<Int>(com.undefined.api.nms.v1_20_6.SpigotNMSMappings.ClientboundSetEntityDataPacketEntityID)
...
fun ClientboundSetEntityDataPacket.getSynchedEntityDataList() = getPrivateField<List<SynchedEntityData.DataValue<*>>>(
    com.undefined.api.nms.v1_20_6.SpigotNMSMappings.ClientboundSetEntityDataPacketSyncedEntityList)